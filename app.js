...
function seeProjectButton(i) {
  ...
  popupCardDescriptionContent.textContent = "Experimental content creation feature that allows users to add to an existing story over the course of a day without spamming their friends.";
